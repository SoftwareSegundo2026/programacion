...
from .schemas import Token, UserLogin, User, UserCreate, UserInDB, UserUpdate, UserUpdateDisabled, PasswordChange, PasswordReset
from .service import authenticate_user, create_user_access_token, create_user, list_users, update_user_disabled, update_user_profile, change_password, reset_password, delete_user
...
async def update_current_user(
    ...
    await log_activity(db, current_user.username, "update", "Profile updated")
    return user
